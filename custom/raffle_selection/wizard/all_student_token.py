...
class StudentReportWizard(models.TransientModel):
    ...
    def action_print_token_reports(self):
        ...
        print(data)
        return self.env.ref('raffle_selection.report_student_token_record').report_action(self, data=data)
